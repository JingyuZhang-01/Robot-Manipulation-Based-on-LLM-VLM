...
def get_config(env=None, config_path=None):
    ...
    if config_path is None:
        assert env.lower() == 'realenv'
        #config_path = './configs/realenv_config.yaml'
        config_path ='/home/elephant/Grasp/github/Robot-Manipulation-Based-on-LLM-VLM-main/src/configs/realenv_config.yaml' # config path
...
def main():
    config = get_config(config_path='./configs/realenv_config.yaml')
    print(config)
